...
<title>登录|至诚微座</title>
<meta name="keywords" content="至诚微座admin">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">至诚微座admin</h2>
</div>
...
<div class="footer">Person &nbsp;  @ SKJOR </div>
